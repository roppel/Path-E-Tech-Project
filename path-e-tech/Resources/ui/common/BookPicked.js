...
function navBar(_title){
	...
	var backBttn = Ti.UI.createButton({
		...
		height : 30,
		width : 70,
		backgroundImage : '/images/buttons/books.png'
	});
...
submitButton.addEventListener('click', function() {
  ...
  alert.show();
  	...
  	var json;
  	var url = "http://108.166.89.121/Recommender.php?functionCall=LeaveRequest&uid="+ win.userID + "&iid=" + win.itemID + "&type=books&rate=" + ratingControl.getValue();
